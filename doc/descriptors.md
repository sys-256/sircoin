# Support for Output Descriptors in Sircoin Core

Since Sircoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `sir1...` for mainnet or `tsir1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Sircoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Sircoin Core wallets, a convenience function `combo` is
