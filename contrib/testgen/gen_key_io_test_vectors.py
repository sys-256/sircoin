...
bech32_templates = [
  ...
  ('sir',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('sir',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('sir',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tsir',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tsir',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tsir',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rsir',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rsir',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rsir', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tsir',  17, 32, False, False, False),
  ('rsir',  3,  1, False, False, False),
  ('sir',   15, 41, False, False, False),
  ('tsir',  0, 16, False, False, False),
  ('rsir',  0, 32, True,  False, False),
  ('sir',   0, 16, True,  False, False),
  ('tsir',  0, 32, False, True,  False),
  ('rsir',  0, 20, False, False, True)
]
