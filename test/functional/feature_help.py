...
"""Verify that starting sircoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start sircoin with -h for help text")
        ...
        self.log.info("Start sircoin with -version for version information")
        ...
        self.log.info("Start sircoind with -fakearg to make sure it does not start")
