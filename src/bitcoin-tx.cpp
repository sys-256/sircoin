...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " sircoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  sircoin-tx [options] <hex-tx> [commands]  Update hex-encoded sircoin transaction\n" +
            "or:     sircoin-tx [options] -create [commands]   Create hex-encoded sircoin transaction\n" +
            "\n";
