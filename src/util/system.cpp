...
const char * const BITCOIN_CONF_FILENAME = "sircoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Sircoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Sircoin";
#else
    // Unix
    return pathRet / ".sircoin";
#endif
#endif
}
